...
const cardPage = ()=>{
    const wrapHolder = (0, _redom.el)("div.form__input-wrap.form__input-wrap_holder", [
        ...
        (0, _redom.el)("input.input input__holder")
    ]);
    const wrapNumber = (0, _redom.el)("div.form__input-wrap.form__input-wrap_number", [
        (0, _redom.el)("label.form__label.form__number-label", "Card Number"),
        (0, _redom.el)("input.input input__number")
    ]);
    const wrapDate = (0, _redom.el)("div.form__input-wrap.form__input-wrap_date", [
        (0, _redom.el)("label.form__label.form__date-label", "Card Expiry"),
        (0, _redom.el)("input.input input__date")
    ]);
    const wrapCvv = (0, _redom.el)("div.form__input-wrap.form__input-wrap_cvv", [
        (0, _redom.el)("label.form__label.form__cvv-label", "CVV"),
        (0, _redom.el)("input.input input__cvv")
    ]);
    const form = (0, _redom.el)("form.form", wrapHolder, wrapNumber, wrapDate, wrapCvv, (0, _redom.el)("button.form__button", "CHECK OUT"));
    const cardPersonal = (0, _redom.el)("div.card__personal", [
        (0, _redom.el)("span.card__name", "John Doe"),
        (0, _redom.el)("span.card__date", "04/24")
    ]);
    const cardImage = (0, _redom.el)("div.credit-card", [
        (0, _redom.el)("span.card__number", "xxxx xxxx xxxx xxxx"),
        cardPersonal
    ]);
    const cardContainer = (0, _redom.el)("div.card", [
        (0, _redom.el)("p", {
            className: "secure"
        }, "Secure Checkout"),
        cardImage,
    ...
    return (0, _redom.el)("div.wrapper", [
        cardContainer
    ]);
};
(0, _redom.setChildren)(document.body, cardPage());
